...
dir = "output/"
max_num_params = 8
df = pd.read_csv(dir + 'moments_output_Europe.tsv', sep='\t', header=None,
...
df_tab = df_tab[['model', 'num_conv', 'll', 'coll_pop_ll', 
                 'est0', 'est1', 'est2', 'est3', 'est4', 'est5', 'est6', 'est7']]
df_tab.columns = ['Model', 'Num. converged', 'Max. log-likelihood',
                  'Max. collapsed log-likelihood', 'est0', 'est1', 'est2',

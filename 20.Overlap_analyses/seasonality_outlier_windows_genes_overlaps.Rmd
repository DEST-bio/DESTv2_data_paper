...
Load data
```{r}
load(file=here::here("rdata/dest2_seasonality/","overlaps.RData"))
```
...
# Save this table
write.table(d_reduced,here::here("rdata/dest2_seasonality","overlaps_genes_table.tab"),
...
```{r}
upset(d_reduced,intersect = names(l),sort_sets=FALSE,min_size=10,
      base_annotations=list(
        'Intersection size'=intersection_size(
            text=list(
                vjust=0.5,

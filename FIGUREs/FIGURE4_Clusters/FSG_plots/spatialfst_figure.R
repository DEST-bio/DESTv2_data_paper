...
load("/Users/jcnunez/Library/CloudStorage/OneDrive-UniversityofVermont/Documents/GitHub/DESTv2_data_paper/FIGUREs/FIGURE4_Clusters/FSG_plots/spatialFST_figure.RData")
...
figureA  
ggsave(figureA, file = "figureA.pdf", h = 2.5, w = 3)
...
figureB <- ggplot(b1[b1$type=="Including\nheterochromatin",], aes(color = chrom, y = mean, x = stat)) +
  ...
  ggtitle(unique(b1$analysis))
figureB   
ggsave(figureB, file = "figureB.pdf", h = 2.5, w = 3.5)
...
figureC
ggsave(figureC, file = "figureC.pdf", h = 2.5, w = 3.5)
...
figureD
ggsave(figureD, file = "figureD.pdf", h = 6, w = 9)

...
def run_moments(sfs_file: str,
    ...
    :param init_params_gen_mode str: Mode for generating initial parameters. Either
        "from_collected_output",  which uses slight perturbations of the output
        from prior inference on similar data, or "uniform", which uniformly samples
    ...
    # in hours; this does nothing but provide output here, and should be set here 
    # to mirror the value in `wrapper_run_moments.slurm`
    time_limit = 2

...
def get_admixture_dem(n_anc, params):
    ...
    dem.add_population(name="C", initial_size=n_anc*nu_admix)

    # Admixture of two derived populations
    dem.add_admixture(derived="C", ancestral=["A", "B"],

...
def main():
    options_file = "options_run_moments_Transatlantic_expandedAfr.tsv"
    model = "admixture"
    pop_of_interest_codes = range(4)
    moments_output_file = "output/moments_output_Transatlantic_expandedAfr.tsv"
    data_dir = "data/sfss/"
    sfs_file = f"{data_dir}k4_Transatlantic_expandedAfr.npy"
